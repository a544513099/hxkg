...
public class ImageMagick {
    final static Logger logger = LoggerFactory.getLogger(ImageMagick.class);
    ...
    static {
        ...
        if (StringUtils.containsIgnoreCase(osName, "win")) {
            imageMagickPath = "c:\\Program Files\\ImageMagick-6.7.7-Q16";
            isWin=true;
    ...
    public static void resizeImage(int width, int height, String srcPath, String newPath) throws Exception {
    	logger.debug("ImageMagick.resizeImage:" + width + ":" + height + "," + srcPath + "," + newPath);
        IMOperation op = new IMOperation();
        op.addImage();
        op.resize(width, height);
        op.addImage();
        //op.addRawArgs("-debug all");
        ConvertCmd convert = new ConvertCmd();
        //linux下不要设置此值
        if (isWin) {
            convert.setSearchPath(imageMagickPath);
    ...
    public static int makeSmallPic(String oriPicPath, String smallPicPath) {
        try {
        	...
        	logger.error("makeSmallPicError:"+e.getMessage(), e);
    ...
    public static int makeBigPic(String oriPicPath, String bigPicPath, int isShuiyin) {
        try {
        	...
        	logger.error("makeBigPicError:"+e.getMessage(), e);
    ...
    public static int makeCoverPic(String oriPicPath, String coverPicPath, int isShuiyin) {
        try {
        	...
        	logger.error("makeCoverPicError:"+e.getMessage(), e);
    ...
    public static int picPutInOtherPath(String oriImgPath, int type, int isShuiyin) {
        ...
        String middleFilePath = oriImgSrc + File.separator + "middle" + File.separator + fileName;
        String coverFilePath = oriImgSrc + File.separator + "cover" + File.separator + fileName;
        String smallFilePath = oriImgSrc + File.separator + "small" + File.separator + fileName;
        String bigFilePath = oriImgSrc + File.separator + "big" + File.separator + fileName;
        String scrollFilePath = oriImgSrc + File.separator + "scroll" + File.separator + fileName;
        String detailFilePath = oriImgSrc + File.separator + "detail" + File.separator + fileName;
    ...
    public static void dirCheckAndMake(String oriImgSrc) {
        ...
        String middleFilePath = oriImgSrc + File.separator + "middle" + File.separator;
        String coverFilePath = oriImgSrc + File.separator + "cover" + File.separator;
        String smallFilePath = oriImgSrc + File.separator + "small" + File.separator;
        String bigFilePath = oriImgSrc + File.separator + "big" + File.separator;
        String scrollFilePath = oriImgSrc + File.separator + "scroll" + File.separator;
        String detailFilePath = oriImgSrc + File.separator + "detail" + File.separator;
    ...
    public static int picPutInUsefulPath(String oriImgSrc, CommonsMultipartFile file_upload, int type, int isShuiyin) throws Exception {
        String fileName = oriImgSrc.substring(oriImgSrc.lastIndexOf(File.separator) + 1);
        oriImgSrc = oriImgSrc.substring(0, oriImgSrc.lastIndexOf(File.separator));
        //六种图片路径+原图路径
        String middleFilePath = oriImgSrc + File.separator + "middle" + File.separator + fileName;
        String coverFilePath = oriImgSrc + File.separator + "cover" + File.separator + fileName;
        String smallFilePath = oriImgSrc + File.separator + "small" + File.separator + fileName;
        ...
        String scrollFilePath = oriImgSrc + File.separator + "scroll" + File.separator + fileName;
        String detailFilePath = oriImgSrc + File.separator + "detail" + File.separator + fileName;
        String oriFilePath = oriImgSrc + File.separator + fileName;
